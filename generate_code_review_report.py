...
--------------------------
{('\n'.join(report_summary)) if report_summary else "No pull requests available. Summary: All good, no pull requests to review."}

--------------------------
Individual Pull Request Details
--------------------------
{('\n'.join(report_details)) if report_details else "No individual pull requests to review. Everything is running smoothly."}
